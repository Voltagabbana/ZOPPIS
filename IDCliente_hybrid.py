...
"""
        ...
        # Configurazione generazione e invocazione del modello
        generation_config = {
            "temperature": 0.1,
            "top_p": 0.95,
            "top_k": 40,
            "max_output_tokens": 8192,
            "response_mime_type": "application/json",  # Risposta in formato JSON
        }
        ...
        output_rag = model_rag.generate_content(prompt_rag)
        print("\nRisultato generato:")
